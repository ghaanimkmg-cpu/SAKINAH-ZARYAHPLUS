...
export const SakinahShell: React.FC<SakinahShellProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#07090f] text-[#EDE7DA] font-sans px-4 sm:px-6 md:px-8 lg:px-12 py-8 pb-20 relative overflow-hidden">
      ...
      />
      <div className="relative z-10 max-w-[1100px] mx-auto h-full">
        {children}
      </div>
    </div>
  );
