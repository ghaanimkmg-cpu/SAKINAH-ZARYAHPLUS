    ...
    <SakinahShell>
      ...
      <main className="mt-6 flex flex-col gap-6">
        ...
        <div className="space-y-6">
          ...
          <button className="w-full py-[14px] mt-4 rounded-[14px] border border-[rgba(201,138,138,0.3)] text-[#C98A8A] font-sans text-[14px] font-medium transition-colors hover:bg-[rgba(201,138,138,0.1)]">
            Report an Incident
          </button>
        </div>
      </main>
